...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting dirhistory history jsontools macos z colored-man-pages)
...
alias v='vim'
alias docker-desk="open -na 'Docker Desktop'"
# eval "$(rbenv init -)"


export lnxsrv='varmaraj@lnxsrv15.seas.ucla.edu'


export PATH=/Users/pranav/Library/Python/3.8/bin:$PATH
...
#
#
#SHORTCUTS AND FUNCTIONS FOR VI MODE
#
#
